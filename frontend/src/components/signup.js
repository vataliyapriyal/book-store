                    ...
                    <div className="modal-box text-black bg-white">
                        <form method="dialog" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='mt-4 space-y-2'>
                                <span>Name</span><br />
                                <input type='text' placeholder='Enter your full name' className='w-80 px-3 border rounded-md outline-none bg-white text-black' {...register("fullname", { required: true })} />
                            ...
                            <div className='mt-4 space-y-2'>
                                <span>Email</span><br />
                                <input type='email' placeholder='Enter your email' className='w-80 px-3 border rounded-md outline-none bg-white text-black' {...register("email", { required: true })} />
                            ...
                            <div className='mt-4 space-y-2'>
                                ...
                                <input type='Password' placeholder='Enter your Password' className='w-80 px-3 border rounded-md outline-none bg-white text-black' {...register("password", { required: true })} />
